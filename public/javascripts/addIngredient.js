...
function addFields(divName) {
    ...
    var selectHTML = "";
    selectHTML = '<div class="col"><label class="gray center" for="ingWholeNumber">Numeric Quantity:</label></div><div class="col"><input type="number" name="ingWholeNumber" id="ingWholeNumber" min="0" value="0" step=".1" class="input form-control recipeForm"></div>';
